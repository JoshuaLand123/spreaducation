...
class TuteeProfileTable(tag: Tag) extends Table[TuteeProfile](tag, "tutee_profile") {
  ...
  override def * = (userID, gender, dob, classLevel, schoolName, mainLanguage, subjectImprove1, scoreSubjectImprove1, subjectImprove2, scoreSubjectImprove2, subjectGoodAt1, scoreSubjectGoodAt1, subjectGoodAt2, scoreSubjectGoodAt2, interest1, timeInterest1, interest2, timeInterest2, interest3, timeInterest3, tutorOrder, imageByte) <> (TuteeProfile.tupled, TuteeProfile.unapply)
