...
object Language extends Enumeration {
  ...
  Catalan, Cebuano, Chechen, Cherokee, Chinese, Croatian, Czech, Dakota, Danish, Dari, Dholuo, DutchEnglish, Esperanto,
  Estonian, Éwé, Finnish, French, Georgian, German, Gikuyu, Greek, Guarani, Gujarati, HaitianCreole, Hausa, Hawaiian,
  HawaiianCreole, Hebrew, Hiligaynon, Hindi, Hungarian, Icelandic, Igbo, Ilocano, Indonesian, InuitOrInupiaq,
